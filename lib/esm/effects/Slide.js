...
const Slide = props => {
  ...
  const xPosition = props.slide === "right" ? -xDistance : props.slide === "left" ? xDistance : 0;
  const yPosition = props.slide === "up" ? -yDistance : props.slide === "down" ? yDistance : hasNoHorizontalDirection ? -yDistance : props.slide == "right" || props.slide === "left" ? 0 : yDistance;
